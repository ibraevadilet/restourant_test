...
class _$_Restaurant implements _Restaurant {
  ...
  @override
  String toString() {
    return 'Restaurant(isFavourite: $isFavourite, id: $id, title: $title, description: $description, scheduleId: $scheduleId, coordsId: $coordsId, userId: $userId, schedule: $schedule, coords: $coords, images: $images, user: $user)';
  }
