...
class _$_Restaurant extends _Restaurant {
  ...
  @override
  String toString() {
    return 'Restaurant(isFavourite: $isFavourite, id: $id, title: $title, description: $description, scheduleId: $scheduleId, coordsId: $coordsId, userId: $userId, schedule: $schedule, coords: $coords, images: $images, user: $user, likes: $likes)';
  }
...
abstract class _Restaurant extends Restaurant {
  factory _Restaurant(
      ...
      final List<dynamic>? images,
      final User? user,
      final List<Like>? likes}) = _$_Restaurant;
